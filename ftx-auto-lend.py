            ...
            if coin_detail[0]:
                if truncate(coin_detail[0]['lendable'],8) > truncate(coin_detail[0]['locked'],8):
                    try:
                        ...
                        logging.info(wallet + ' | Updated Lending Offer for ' + str(coin_detail[0]['coin']) + ' from ' + str(truncate(coin_detail[0]['locked'],8)) + ' to ' + str(truncate(coin_detail[0]['lendable'],8)) + ' at ' + str(coin_detail[0]['minRate']))
                    ...
                    logging.info(wallet + ' | No changes to Lending Offer for ' + str(coin_detail[0]['coin']) + ' ' + str(truncate(coin_detail[0]['lendable'],8)) + ' at ' + str(coin_detail[0]['minRate']))
                    _print_lending_offer_details(coin_detail[0])
